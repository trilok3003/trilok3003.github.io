import{Gb as s,Mc as e}from"./chunk-HHIH4HLP.js";var a=(()=>{class t{constructor(){this.cols="auto-fit",this.minWidth="12.5em",this.maxWidth="1fr",this.gap="1rem",this.rowHeight="auto"}get getStyle(){return`
     margin: 1rem 0;
     display: grid;
